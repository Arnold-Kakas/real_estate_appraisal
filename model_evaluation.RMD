...
Log transformation help with this issue to some extent. 
...
```
<br>
Again, we can see that most expensive apartments are from western part of Slovakia with exceptions of Košice I and Poprad. On the other hand all of the bottom 10 districts are located in eastern part. There I need to note, that most of these districts have very low number of advertisements. This can tell us two things. Firstly, the low prices can be due to chance. Secondly, the real estate market in this part of Slovakia is less developed.

#### Municipality
<br>
For municipalities I will not do EDA since there are more than 200 unique values. Only to put in to perspective, there is 2890 municipalities (considering Bratislava and Košice as single entities without split to city districts). Only around 150 of them have more than 5000 inhabitants.
