...
```{r price_histo, message=FALSE, warning=FALSE}
...
```
<br>
```{r price_boxplot, message=FALSE, warning=FALSE}
...
```{r top_10_districts_chart, message=FALSE, warning=FALSE}
...
<br>
```{r index_histo, message=FALSE, warning=FALSE}
...
<br>
```{r index_price, message=FALSE, warning=FALSE}
scraped_cleaned_no_outliers %>% 
  select(price, index) %>% 
  drop_na() %>% 
...
<br>
```{r area_histo, message=FALSE, warning=FALSE}
scraped_cleaned_no_outliers %>% 
...
<br>
```{r area_price, message=FALSE, warning=FALSE}
scraped_cleaned_no_outliers %>% 
  filter(area < 200 & area > 10) %>% 
...
<br>
```{r index_district_histo, message=FALSE, warning=FALSE}
scraped_cleaned_no_outliers %>% 
...
```{r index_districts_price, message=FALSE, warning=FALSE}
scraped_cleaned_no_outliers %>% 
