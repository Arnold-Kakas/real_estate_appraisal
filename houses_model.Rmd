...
def extract_topics(text, nlp, num_topics=5):
    doc = nlp(text)
...
```{python, results='asis'}
# Load the en language model
nlp = spacy.load("en_core_web_sm")
doc = nlp(houses_r.info_text_en[0])
text = nlp(houses_r.info_text_en[0])
print(doc)
...
spacy.displacy.render(sentence1, style = "dep")

token23 = sentence1[19]
print(token23)
extract_topics(text, nlp)
text
```
