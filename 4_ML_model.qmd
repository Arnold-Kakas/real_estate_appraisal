...
shap_plot
```
Okrem celkového príspevku jednotlivých premenných v rámci modelu ako celku (globálne vysvetlenie) sa vieme pozrieť aj na jednotlivé predikcie. Napr. keď sa pozrieme na inzerát na riadku 1804, môžeme vidieť, že lokalita v okrese Bratislava I mu pridala na hodnote 48,5 tisíc EUR, geografická dĺžka ďalších 36,3 tisíc EUR, geografická šírka 19,5 tisíc EUR a rozloha 84 m^2 19,2 tisíc EUR. Naopak to, že sa nejedná o novostavbu znižuje cenu o 12,6 tisíc EUR a pôvodný stav uberá ďalších, približne, 8 tisíc EUR.
...
Finalizovaný model ukladáme v RDS formáte a bude použitý v Shiny web aplikácii.
